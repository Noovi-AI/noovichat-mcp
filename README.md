...
The server wraps the NooviChat REST API and exposes **270+ tools across
22 feature areas** — every customization the NooviChat platform adds on
...
| **NooviLicense / NooviLabs / Audio** | 0 (today) | No public API yet — JSDoc roadmaps included |
| **Total** | **270** | Across 22 feature modules |
...
> "List my open pipeline cards in the **B2B Outbound** funnel that are
> assigned to me and have lead_score above 60."
